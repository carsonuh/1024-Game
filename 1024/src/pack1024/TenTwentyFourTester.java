...
public class TenTwentyFourTester {
    ...
    public void testSetValues()
    {
        ...
        List<Cell> zeroList = (List<Cell>) gameLogic.getNonEmptyTiles();
        ...
        assertTrue("setValues() is not implemented correctly", zeroList.equals(oneList));
    }
